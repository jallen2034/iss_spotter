...
// call the fetchMyIP() function here, calling this function returns a promise, this returned promise in turn resolves with the
...
fetchMyIP()
  // remember the .then methods will only run if no errrors are encountered. The body which was previously resolved by the returned promise above now becomes IP address
  ...
  // the erorr handling in this final .catch was already resolved in the returned promise from fetchMyIP(). If that resolved an error
  // it is dumped here
